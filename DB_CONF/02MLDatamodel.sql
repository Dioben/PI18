...
CREATE INDEX "EPOCH_VALUES_MIXED" ON "Epoch_values" ("sim_id","epoch");

LTER TABLE "Tags" ADD CONSTRAINT "Tags_tag_sim_id_87f794ba_uniq" UNIQUE ("tag", "sim_id");
...
CREATE INDEX "TAG_NAME_id_12443223" ON "Tags"("tag");
